...
plot 'BubbleIterativoLista.txt' with linespoints title 'BubbleIterativoLista', 'BubbleIterativoVetor.txt' with linespoints title 'BubbleIterativoVetor','insertionsortIterativoLista.txt' with linespoints title 'insertionsortIterativoLista','InsertSortIterativoVetor.txt' with linespoints title 'InsertSortIterativoVetor','selectionsortLista.txt' with linespoints title 'selectionsortLista','SelectSortIterativoVetor.txt' with linespoints title 'SelectSortIterativoVetor'


plot 'MergeSortIterativoVetor.txt' with linespoints title 'MergeSortIterativoVetor','MergeSortRecursivoVetor.txt' with linespoints title 'MergeSortRecursivoVetor','QuickSortIterativoVetor.txt' with linespoints title 'QuickSortIterativoVetor','QuickSortRecursivoVetor.txt' with linespoints title 'QuickSortRecursivoVetor','HeapSortIterativoVetor.txt' with linespoints title 'HeapSortIterativoVetor','HeapSortRecursivoVetor.txt' with linespoints title 'HeapSortRecursivoVetor'


plot 'BubbleIterativoVetor.txt' with linespoints title 'BubbleIterativoVetor','BubbleSortRecursivoVetor.txt' with linespoints title 'BubbleSortRecursivoVetor','InsertSortIterativoVetor.txt' with linespoints title 'InsertSortIterativoVetor','InsertSortRecursivoVetor.txt' with linespoints title 'InsertSortRecursivoVetor','SelectSortIterativoVetor.txt' with linespoints title 'SelectSortIterativoVetor','SelectSortRecursivoVetor.txt' with linespoints title 'SelectSortRecursivoVetor'
...
plot  'BubbleIterativoVetor.txt' with linespoints title 'BubbleIterativoVetor','HeapSortIterativoVetor.txt' with linespoints title 'HeapSortIterativoVetor','InsertSortIterativoVetor.txt' with linespoints title 'InsertSortIterativoVetor','MergeSortIterativoVetor.txt' with linespoints title 'MergeSortIterativoVetor','QuickSortIterativoVetor.txt' with linespoints title 'QuickSortIterativoVetor','SelectSortIterativoVetor.txt' with linespoints title 'SelectSortIterativoVetor'

plot  'BubbleSortRecursivoVetor.txt' with linespoints title 'BubbleSortRecursivoVetor','BubbleIterativoLista.txt' with linespoints title 'BubbleIterativoLista','HeapSortRecursivoVetor.txt' with linespoints title 'HeapSortRecursivoVetor','InsertSortRecursivoVetor.txt' with linespoints title 'InsertSortRecursivoVetor','MergeSortRecursivoVetor.txt' with linespoints title 'MergeSortRecursivoVetor','QuickSortRecursivoVetor.txt' with linespoints title 'QuickSortRecursivoVetor','SelectSortRecursivoVetor.txt' with linespoints title 'SelectSortRecursivoVetor'
