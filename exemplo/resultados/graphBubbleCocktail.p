...
plot 'BubbleIterativoVetor.txt' with linespoints title 'BubbleIterativoVetor','BubbleSortRecursivoVetor.txt' with linespoints title 'BubbleSortRecursivoVetor','HeapSortIterativoVetor.txt' with linespoints title 'HeapSortIterativoVetor','HeapSortRecursivoVetor.txt' with linespoints title 'HeapSortRecursivoVetor','InsertSortIterativoVetor.txt' with linespoints title 'InsertSortIterativoVetor','InsertSortRecursivoVetor.txt' with linespoints title 'InsertSortRecursivoVetor'
